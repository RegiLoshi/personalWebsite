    ...
    <DataContext.Provider value={data}>
      <div className=" min-h-screen flex flex-col space-y-10 py-10 lg:py-24 px-6 w-full mx-auto lg:w-1/2 lg:px-4">
        ...
        <div className="flex flex-col space-y-10 lg:px-6">
          <section>
            <h2 className="text-lg lg:text-xl font-bold dark:text-white">Work Experience</h2>
          ...
          <section>
            <h2 className="mt-6 text-lg lg:text-xl font-bold dark:text-white">Education</h2>
            <div className="flex flex-col gap-4 mt-4">
          ...
          <section>
            <h2 className="mt-6 text-lg text-center lg:text-xl font-bold dark:text-white">My Projects</h2>
            <p className="text-center font-light text-lg dark:text-gray-400">
          ...
          <div className="flex flex-col items-center space-y-4">
            <h2 className="text-lg lg:text-xl font-bold dark:text-white">Get in touch</h2>
